...
var list = {
	...
	advertisers: {
		...
		subOrder: 1,
		method: (req, res) => {
			~['active', 'deactive', 'other'].indexOf(req.query.tab) ? res.render('adv/' + (req.query.tab || 'active') + '/index') : res.redirect('advertisers?tab=active');
		},
		order: 1,
		tabs: {
			'active': {
...
//# sourceMappingURL=helloy-compiled.js.map